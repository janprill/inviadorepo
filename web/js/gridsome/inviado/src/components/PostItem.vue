      ...
      <div class="py-8 sm:py-20 border-b border-gray-300">
        <header class="text-center mb-8">
          ...
          <p class="text-gray-200 leading-normal text-sm sm:text-base">
            ...
            <span v-if="post.tags && post.tags.length > 0"> in <g-link :to="`${post.tags[0].path}/`" class="text-gray-200 capitalize border-b border-transparent hover:border-gray-400 transition-border-color">{{ titleCase(post.tags[0].title) }}</g-link></span>
