<template>
  <div class="p-2 pl-8 pt-6 h-auto">
    ...
    <div class="shadow shadow-primary pt-8 mt-4">
      <section class="flex -ml-4">
        ...
        <div class="flex-grow bg-gray-200 border bg-gray-800">
          <h2 class="text-gray-100 text-2xl pl-2">
            Inviado Ltd &amp; Co KG
          </h2>
        </div>
      </section>
      ...
      <section class="m-3 pb-4 text-gray-100 flex flex-wrap">
        <font-awesome :icon="['fab', 'github']" class="text-white h-5 w-5 shadow-lg m-1 rounded"/>
        <font-awesome :icon="['fab', 'xing-square']" class="text-white h-5 w-5 shadow-lg m-1 rounded"/>
      </section>
      <section>
        <More />
      </section>
