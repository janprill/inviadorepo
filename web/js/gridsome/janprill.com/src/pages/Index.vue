            ...
            <div class="text-lg mt-6 text-gray-400">
              ...
              <div class="mt-8">
                <a
                  ...
                  target="_blank"
                  href="https://keybase.io/team/inviado"
                >
        ...
        <section class="md:flex md:flex-row-reverse mt-32 w-full">
          <article class="bg-primary w-full max-w-xl shadow-primary m-0 p-6 md:p-12 md:pl-16 mb-auto">
            ...
            <div class="text-lg mt-6">
              <p class="mt-4">
                Without nagging, with the pure conscience of a person who gives his best, I build within a team, or alone Minimum Viable Products, start your eCommerce, or am your kick starter in the
                digitalization of your business.
              </p>
              <p class="mt-4">
                Occasionally when an internal team is no longer properly motivated, it needs an impulse from outside. I love being that impulse. I build up islands of
                good behavior and before your team realizes it's working at full power again. 
              </p>
            </div>
          </article>
          ...
          <article class="bg-saint flex flex-col w-full rounded-sm lg:max-w-xl shadow-primary h-auto md:mt-16 md:-mr-8 p-6 mb-auto text-base text-gray-800">
            ...
            <p class="mt-4">
              I value crystal clear communication. I have no problem demanding from other people what I myself am willing to give: The best performance I can get and the willingness to learn at all
              times. In this way I encourage the desire to perform and maintain it until the goal is reached. In order to then directly strive for the next success.
            </p>
            <p class="mt-4">
              Let's push things forward.
            </p>
            <div class="my-8">
              <g-image src="/fwd.png" class="bg-animate rounded shadow-primary border-2 border-gray-500" />
            </div>
          </article>
        </section>
