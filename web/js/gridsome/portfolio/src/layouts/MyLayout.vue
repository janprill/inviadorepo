<template>
  <div class="">
    <header class="sm:flex sm:items-center sm:justify-between xl:bg-white">
    ...
    My Layout. TODO: make it a great tailwind layout.
    <slot /> <!-- Page content will be inserted here  -->

    <h1 class="text-white font-headline text-5xl">Meta serif headline</h1>
    <p class="text-gray-200 font-copy text-3xl">Narative brands, builds and markets products on behalf of growth-minded companies.</p>
